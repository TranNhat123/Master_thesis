...
radius = 0.005  # Bán kính của hình cầu
...
while True:
    ...
    if Case_sixdof == 1:
        ...
        y_target = 0.4
        z_target = 0.3
        Goal_sixdof_orientation = np.array([ 0, 0, 0])
    ...
    att_sixdof_jacobian = T06_sixdof_function(t6, t7, t8, t9, t10, t11, Goal_sixdof_orientation[0], Goal_sixdof_orientation[1], Goal_sixdof_orientation[2])
    ...
    # ---------------- Step 3: Determine v_att_tool_position_sixdof and vv_att_tool_position_sixdof --------------------
    # ---------------- Step 3: Determine v_att_tool_position_sixdof and vv_att_tool_position_sixdof --------------------
    # ---------------- Step 3: Determine v_att_tool_position_sixdof and vv_att_tool_position_sixdof --------------------
